 ...
 main (int argc, char** argv)
{
  ...
  tree->setInputCloud (x_filtered_transformed_cloud);
  n.setInputCloud (x_filtered_transformed_cloud);
  ...
  pcl::concatenateFields (*x_filtered_transformed_cloud, *normals, *cloud_with_normals);
